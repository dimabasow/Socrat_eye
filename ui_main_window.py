...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy1.setHeightForWidth(self.treeWidget_calculations.sizePolicy().hasHeightForWidth())
        self.treeWidget_calculations.setSizePolicy(sizePolicy1)
        self.treeWidget_calculations.setContextMenuPolicy(Qt.CustomContextMenu)
        ...
        self.treeWidget_calculations.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        self.tab_correcting = QWidget()
        self.tab_correcting.setObjectName(u"tab_correcting")
        self.verticalLayout_8 = QVBoxLayout(self.tab_correcting)
        ...
        self.treeWidget_corrected_parameters = QTreeWidget(self.tab_correcting)
        self.treeWidget_corrected_parameters.setObjectName(u"treeWidget_corrected_parameters")
        self.treeWidget_corrected_parameters.setContextMenuPolicy(Qt.CustomContextMenu)
        self.treeWidget_corrected_parameters.setSelectionMode(QAbstractItemView.ExtendedSelection)

        self.verticalLayout_6.addWidget(self.treeWidget_corrected_parameters)

        self.horizontalLayout_18 = QHBoxLayout()
        self.horizontalLayout_18.setObjectName(u"horizontalLayout_18")
        self.button_up_correcting = QPushButton(self.tab_correcting)
        ...
        self.button_down_correcting = QPushButton(self.tab_correcting)
        ...
        self.label_4 = QLabel(self.tab_correcting)
        ...
        self.label_3 = QLabel(self.tab_correcting)
        self.label_3.setObjectName(u"label_3")

        self.verticalLayout.addWidget(self.label_3)

        self.text_edit_correcting_expression = QTextEdit(self.tab_correcting)
        ...
        sizePolicy5.setHeightForWidth(self.text_edit_correcting_expression.sizePolicy().hasHeightForWidth())
        self.text_edit_correcting_expression.setSizePolicy(sizePolicy5)

        self.verticalLayout.addWidget(self.text_edit_correcting_expression)

        self.button_corrected_parameters_add = QPushButton(self.tab_correcting)
        ...
        self.tabWidget_main.addTab(self.tab_correcting, "")
        ...
        self.treeWidget_graphs_single.setContextMenuPolicy(Qt.CustomContextMenu)
        self.treeWidget_graphs_single.setEditTriggers(QAbstractItemView.DoubleClicked)
        self.treeWidget_graphs_single.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        self.treeWidget_graphs_multy.setContextMenuPolicy(Qt.CustomContextMenu)
        self.treeWidget_graphs_multy.setEditTriggers(QAbstractItemView.DoubleClicked)
        self.treeWidget_graphs_multy.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        sizePolicy4.setHeightForWidth(self.text_edit_graphs_description.sizePolicy().hasHeightForWidth())
        self.text_edit_graphs_description.setSizePolicy(sizePolicy4)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_down_chrono_name.sizePolicy().hasHeightForWidth())
        self.line_cut_down_chrono_name.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_down_chrono_value.sizePolicy().hasHeightForWidth())
        self.line_cut_down_chrono_value.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_up_chrono_name.sizePolicy().hasHeightForWidth())
        self.line_cut_up_chrono_name.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_up_chrono_value.sizePolicy().hasHeightForWidth())
        self.line_cut_up_chrono_value.setSizePolicy(sizePolicy6)
        ...
        sizePolicy4.setHeightForWidth(self.text_edit_chrono_description.sizePolicy().hasHeightForWidth())
        self.text_edit_chrono_description.setSizePolicy(sizePolicy4)
        ...
        self.treeWidget_key_parameters_single.setContextMenuPolicy(Qt.CustomContextMenu)
        self.treeWidget_key_parameters_single.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        self.treeWidget_key_parameters_multy.setContextMenuPolicy(Qt.CustomContextMenu)
        self.treeWidget_key_parameters_multy.setSelectionMode(QAbstractItemView.ExtendedSelection)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_down_key_parameters_name.sizePolicy().hasHeightForWidth())
        self.line_cut_down_key_parameters_name.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_down_key_parameters_value.sizePolicy().hasHeightForWidth())
        self.line_cut_down_key_parameters_value.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_up_key_parameters_name.sizePolicy().hasHeightForWidth())
        self.line_cut_up_key_parameters_name.setSizePolicy(sizePolicy6)
        ...
        sizePolicy6.setHeightForWidth(self.line_cut_up_key_parameters_value.sizePolicy().hasHeightForWidth())
        self.line_cut_up_key_parameters_value.setSizePolicy(sizePolicy6)
        ...
        sizePolicy4.setHeightForWidth(self.text_edit_key_parameters_description.sizePolicy().hasHeightForWidth())
        self.text_edit_key_parameters_description.setSizePolicy(sizePolicy4)
        ...
        self.label_2 = QLabel(self.tab_save_results)
        ...
        self.line_file_save_name = QLineEdit(self.tab_save_results)
        ...
        self.label_14 = QLabel(self.tab_save_results)
        ...
        self.line_graphs_width = QLineEdit(self.tab_save_results)
        ...
        self.label_16 = QLabel(self.tab_save_results)
        ...
        self.line_numbers_delim = QLineEdit(self.tab_save_results)
        ...
        self.label_15 = QLabel(self.tab_save_results)
        ...
        self.comboBox_font_name = QComboBox(self.tab_save_results)
        self.comboBox_font_name.addItem("")
        self.comboBox_font_name.addItem("")
        self.comboBox_font_name.setObjectName(u"comboBox_font_name")
        self.comboBox_font_name.setEditable(True)

        self.verticalLayout_25.addWidget(self.comboBox_font_name)

        self.comboBox_font_value = QComboBox(self.tab_save_results)
        self.comboBox_font_value.addItem("")
        self.comboBox_font_value.addItem("")
        self.comboBox_font_value.addItem("")
        self.comboBox_font_value.addItem("")
        self.comboBox_font_value.addItem("")
        ...
        self.comboBox_font_value.addItem("")
        self.comboBox_font_value.addItem("")
        self.comboBox_font_value.setObjectName(u"comboBox_font_value")
        self.comboBox_font_value.setEditable(True)

        self.verticalLayout_25.addWidget(self.comboBox_font_value)


        self.verticalLayout_29.addLayout(self.verticalLayout_25)

        self.checkBox_round_chrono = QCheckBox(self.tab_save_results)
        ...
        self.checkBox_round_key_parameters = QCheckBox(self.tab_save_results)
        ...
        self.checkBox_empty_graphs = QCheckBox(self.tab_save_results)
        ...
        self.tabWidget_main.addTab(self.tab_save_results, "")

        self.verticalLayout_2.addWidget(self.tabWidget_main)

        self.textBrowser_terminal = QTextBrowser(self.widget)
        ...
        sizePolicy8.setHeightForWidth(self.textBrowser_terminal.sizePolicy().hasHeightForWidth())
        self.textBrowser_terminal.setSizePolicy(sizePolicy8)
        ...
        self.comboBox_font_value.setCurrentIndex(4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.comboBox_font_value.setItemText(0, QCoreApplication.translate("MainWindow", u"8", None))
        self.comboBox_font_value.setItemText(1, QCoreApplication.translate("MainWindow", u"9", None))
        self.comboBox_font_value.setItemText(2, QCoreApplication.translate("MainWindow", u"10", None))
        self.comboBox_font_value.setItemText(3, QCoreApplication.translate("MainWindow", u"11", None))
        self.comboBox_font_value.setItemText(4, QCoreApplication.translate("MainWindow", u"12", None))
        self.comboBox_font_value.setItemText(5, QCoreApplication.translate("MainWindow", u"14", None))
        self.comboBox_font_value.setItemText(6, QCoreApplication.translate("MainWindow", u"16", None))
        self.comboBox_font_value.setItemText(7, QCoreApplication.translate("MainWindow", u"18", None))
        self.comboBox_font_value.setItemText(8, QCoreApplication.translate("MainWindow", u"20", None))
        self.comboBox_font_value.setItemText(9, QCoreApplication.translate("MainWindow", u"22", None))
        self.comboBox_font_value.setItemText(10, QCoreApplication.translate("MainWindow", u"24", None))
        self.comboBox_font_value.setItemText(11, QCoreApplication.translate("MainWindow", u"26", None))
        self.comboBox_font_value.setItemText(12, QCoreApplication.translate("MainWindow", u"28", None))
        self.comboBox_font_value.setItemText(13, QCoreApplication.translate("MainWindow", u"36", None))
        self.comboBox_font_value.setItemText(14, QCoreApplication.translate("MainWindow", u"48", None))
        self.comboBox_font_value.setItemText(15, QCoreApplication.translate("MainWindow", u"72", None))

        self.comboBox_font_value.setCurrentText(QCoreApplication.translate("MainWindow", u"12", None))
        ...
        self.tabWidget_main.setTabText(self.tabWidget_main.indexOf(self.tab_save_results), QCoreApplication.translate("MainWindow", u"\u0421\u043e\u0445\u0440\u0430\u043d\u0435\u043d\u0438\u0435 \u0440\u0435\u0437\u0443\u043b\u044c\u0442\u0430\u0442\u043e\u0432", None))
